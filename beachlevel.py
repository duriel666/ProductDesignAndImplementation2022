...
def start_game_beach(run, score):
    alive = True
    while alive:
        pygame.init()
        pygame.font.init()
        ...
        point_get = pygame.mixer.Sound('sfx/beach-point.wav')
        ...
        class World(pygame.sprite.Sprite):
            def __init__(self, world_image):
                ...
                self.pos = vec(ww-self.width, wh-self.height)
                self.vel = vec(0, 0)
        ...
        world_list = [light, light2, taakse, taakse2,
